...
public class AlarmsRepository {
    ...
    public AlarmsRepository() {
        ...
        this.alarms.add(new Alarm("alarmId1", "userId1", new Search(Optional.of("KeywordTest1"), Optional.of(new ArrayList<>()), Optional.empty(), Optional.empty())));
        this.alarms.add(new Alarm("alarmId2", "userId2", new Search(Optional.of("KeywordTest2"), Optional.of(new ArrayList<>()), Optional.empty(), Optional.empty())));
    }
